    ...
    <div>
      ...
      <div className="d-flex flex-col align-middle mt-5 justify-center">
        <div className="text-center">
          <h1>
            {data[0] !== undefined && data[0].creatorname !== undefined
              ? `${data[0].creatorname}'s Recipes`
              : "Recipes"}
          </h1>
        </div>

        <div className="Allcards d-flex align-middle justify-center">
          {loading ? (
